...
const Game = (() => {
  ...
  const MEMORIES = [
    { id: 'm1', icon: '🌹', image: 'assets/images/1.jpeg', text: 'أول مرة كلمتك فيها حسيت إن في حاجة حلوة جاية.' },
    { id: 'm2', icon: '📸', image: 'assets/images/2.jpeg', text: 'أول صورة سوا... لسه فاكرها زي إمبارح.' },
    { id: 'm3', icon: '☕', image: 'assets/images/3.jpeg', text: 'أول قعدة سوا، وضحكنا لحد ما وجعنا.' },
    { id: 'm4', icon: '🎵', image: 'assets/images/4.jpeg', text: 'الأغنية اللي بقت "بتاعتنا" من غير ما نتفق.' },
    { id: 'm5', icon: '💌', image: 'assets/images/5.jpeg', text: 'أول رسالة حسيت فيها إنك فاهماني أكتر من نفسي.' },
    { id: 'm6', icon: '🌙', image: 'assets/images/6.jpeg', text: 'الليالي اللي قعدنا نتكلم فيها لحد الفجر.' },
    { id: 'm7', icon: '🎁', image: 'assets/images/7.jpeg', text: 'أول هدية بسيطة فرحتك أكتر من أي حاجة غالية.' },
    { id: 'm8', icon: '❤️', image: 'assets/images/8.jpeg', text: 'اللحظة اللي حسيت فيها إني بحبك بجد.' },
    { id: 'm9', icon: '🌟', image: 'assets/images/9.jpeg', text: 'وكل يوم بعدها... بقيت أنتِ أمنيتي.' },
  ];
  ...
  const WISH_RESULT_MESSAGE = 'اتمني امنيه جميله شبهك ❤️';
