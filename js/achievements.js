...
const Achievements = (() => {
  ...
  function init(savedList) {
    unlocked = new Set(savedList || []);
  }
  ...
  /**
   * يفتح إنجاز جديد إذا لم يكن مفتوحًا من قبل
   * يرجع true إذا تم فتحه الآن لأول مرة
   */
  function unlock(id) {
